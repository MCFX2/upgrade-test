...
public class SceneReference : ISerializationCallbackReceiver
{
	...
	public static string SceneObjProperty = nameof(sceneObject);
	//used for reflection lookup
	public static string ScenePathProperty = nameof(_scenePath);
	...
	private bool IsValidSceneAsset
	{
		get
		{
			...
			return sceneObject is SceneAsset;
		}
	}
#endif
	...
	public string ScenePath
	{
		...
		set
		{
			_scenePath = value;
#if UNITY_EDITOR
			sceneObject = GetSceneAssetFromPath();
#endif
		}
	}
	...
	{
		return sceneObject == null ? string.Empty : AssetDatabase.GetAssetPath(sceneObject);
	}
	...
	private void HandleBeforeSerialize()
	{
		...
		{
			sceneObject = GetSceneAssetFromPath();
			if (sceneObject == null) _scenePath = string.Empty;
	...
	private void HandleAfterDeserialize()
	{
		...
		if (!sceneObject) _scenePath = string.Empty;
...
public class SceneReferencePropertyDrawer : PropertyDrawer
{
    ...
    private static readonly float paddedLineHeight = lineHeight + padSize;
    ...
    private void DrawSceneInfoGUI(Rect position, BuildUtils.BuildScene buildScene, int sceneControlID)
    {
        ...
        {
	        //don't ask where these strings came from
        ...
        using (new EditorGUI.DisabledScope(readOnly))
        {
            ...
            if (buildScene.BuildIndex == -1)
            {
                ...
                tooltipMsg = "Add this scene to build settings. It will be appended to the end of the build scenes as buildIndex: "
    ...
    {
        return property.FindPropertyRelative(SceneReference.SceneObjProperty);
    }

    private static SerializedProperty GetScenePathProperty(SerializedProperty property)
    {
        return property.FindPropertyRelative(SceneReference.ScenePathProperty);
    }
